...
void customerMenu() {
    pageBreak();
    cout << "Welcome " << firstName << ", What would you like to do today? Select from the options below.";
...
void displayUserProfile(vector<Customer>) {
    pageBreak();
    cout << "Email: " << c.email << endl;
    cout << "Name: " << c.firstName << " " << c.lastName << endl;
    cout << "Ph number: " << c.phoneNumber << endl;
